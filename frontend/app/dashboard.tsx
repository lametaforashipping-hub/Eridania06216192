...
export default function Dashboard() {
  ...
  const menuItems = [
    ...
    { icon: 'trophy-outline', emoji: '🏆', label: 'Resultados', route: '/results', roles: ['super_admin', 'admin', 'vendedor'], color: '#f59e0b' },
    { icon: 'notifications-outline', emoji: '🔔', label: 'Notificaciones', route: '/notifications', roles: ['super_admin', 'admin', 'vendedor'], color: '#8b5cf6' },
