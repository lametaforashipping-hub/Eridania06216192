...
BASE_URL = os.environ.get('EXPO_PUBLIC_BACKEND_URL', 'https://magic-lottery-mobile.preview.emergentagent.com')
if not BASE_URL.endswith('.com'):
    BASE_URL = 'https://magic-lottery-mobile.preview.emergentagent.com'
