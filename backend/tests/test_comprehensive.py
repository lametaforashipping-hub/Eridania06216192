...
BASE_URL = os.environ.get('EXPO_PUBLIC_BACKEND_URL', 'https://sales-ticket-update.preview.emergentagent.com')
if not BASE_URL.endswith('.com'):
    BASE_URL = 'https://sales-ticket-update.preview.emergentagent.com'
